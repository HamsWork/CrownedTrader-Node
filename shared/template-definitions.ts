...
const CATEGORY_CONFIGS: Record<Category, {
  ...
  Options: {
    ...
    entryFields: [["Ticker", "{{ticker}}"], ["Contract", "{{contract}}"], ["Strike", "{{strike}}"], ["Expiration", "{{expiration}}"], ["Direction", "{{direction}}"], ["Entry", "${{entry_price}}"], ["Stop Loss", "${{stop_loss}}"]],
    entryTitle: "🚀 {{ticker}} {{strike}}{{direction}} {{expiration}}",
    entryDesc: "New options alert!\nEntry: ${{entry_price}} | SL: ${{stop_loss}}",
    hitVars: ["ticker", "contract", "strike", "expiration", "direction", "entry_price", "exit_price", "profit_pct", "notes"],
    hitFields: [["Ticker", "{{ticker}}"], ["Contract", "{{contract}}"], ["Strike", "{{strike}}"], ["Expiration", "{{expiration}}"], ["Direction", "{{direction}}"], ["Entry", "${{entry_price}}"], ["Exit", "${{exit_price}}"], ["Profit", "{{profit_pct}}%"], ["Notes", "{{notes}}"]],
    hitTitle: "🎯 TP Hit — {{ticker}} {{strike}}{{direction}}",
    hitDesc: "Target reached!\nEntry: ${{entry_price}} → Exit: ${{exit_price}} ({{profit_pct}}%)",
    slRaisedVars: ["ticker", "contract", "strike", "expiration", "direction", "old_stop_loss", "new_stop_loss", "notes"],
    slRaisedFields: [["Ticker", "{{ticker}}"], ["Contract", "{{contract}}"], ["Strike", "{{strike}}"], ["Expiration", "{{expiration}}"], ["Direction", "{{direction}}"], ["Old SL", "${{old_stop_loss}}"], ["New SL", "${{new_stop_loss}}"], ["Notes", "{{notes}}"]],
    ...
    slHitVars: ["ticker", "contract", "strike", "expiration", "direction", "entry_price", "exit_price", "loss_pct", "notes"],
    slHitFields: [["Ticker", "{{ticker}}"], ["Contract", "{{contract}}"], ["Strike", "{{strike}}"], ["Expiration", "{{expiration}}"], ["Direction", "{{direction}}"], ["Entry", "${{entry_price}}"], ["Exit", "${{exit_price}}"], ["Loss", "{{loss_pct}}%"]],
